...
import quizData from '../data/scenarios.json';
...
function ScenariosPage() {
  ...
  return (
    <div>
      <h1 style={{ textAlign: 'center' }}>📋 Scenario Quiz</h1>
      ...
      {!isSubmitted ? (
        ...
        >
          <h2 style={{ textAlign: 'center' }}>🎉 Scenario Quiz Complete!</h2>
